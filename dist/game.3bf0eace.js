...
})({"3Q9Kp":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "a93817393bf0eace";
"use strict";
...
},{}],"hKQx3":[function(require,module,exports) {
var global = arguments[3];
// modules are defined as an array
// [ module function, map of requires ]
//
...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "dXikf": [
        function(require, module1, exports) {
            ...
            var HMR_ENV_HASH = "d6ea1d42532a7575";
            var HMR_USE_SSE = false;
            module1.bundle.HMR_BUNDLE_ID = "b467270ebc81438e";
            "use strict";
            /* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE, HMR_USE_SSE, chrome, browser, __parcel__import__, __parcel__importScripts__, ServiceWorkerGlobalScope */ /*::
import type {
  HMRAsset,
...
${frame.code}`;
        ...
        function(require, module1, exports) {
            ...
            class GameScene extends Phaser.Scene {
                ...
                update() {
                    ...
                    else if (this.cursors.right.isDown) this.player.x += this.playerSpeed;
                    // Handles up/down movement
                    if (this.cursors.up.isDown) this.player.y -= this.playerSpeed;
                    else if (this.cursors.down.isDown) this.player.y += this.playerSpeed;
                }
            }
            // Create game
            window.onload = function() {
                ...
                } else console.log("Phaser is undefined :(");
            };
        },
        {}
    ]
    ...
    "dXikf",
    "jlGnO"
], "jlGnO", "parcelRequire0644");

},{}]},["3Q9Kp","hKQx3"], "hKQx3", "parcelRequire0644")

//# sourceMappingURL=game.3bf0eace.js.map
